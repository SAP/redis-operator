...
func (in *MetricsProperties) DeepCopyInto(out *MetricsProperties) {
	*out = *in
	...
	if in.Service != nil {
		...
		*out = new(MetricsServiceProperties)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricsServiceProperties) DeepCopyInto(out *MetricsServiceProperties) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricsServiceProperties.
func (in *MetricsServiceProperties) DeepCopy() *MetricsServiceProperties {
	if in == nil {
		return nil
	}
	out := new(MetricsServiceProperties)
